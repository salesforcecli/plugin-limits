...
_See code: [src/commands/org/list/limits.ts](https://github.com/salesforcecli/plugin-limits/blob/3.3.55/src/commands/org/list/limits.ts)_
...
_See code: [src/commands/org/list/sobject/record-counts.ts](https://github.com/salesforcecli/plugin-limits/blob/3.3.55/src/commands/org/list/sobject/record-counts.ts)_
